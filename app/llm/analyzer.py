...
_PLACE_QUESTION_TERMS = (
    ...
    "family place",
    "kids activity",
    "ou emmener les enfants",
    "ou emmener mes enfants",
)
...
_GENERAL_QUESTION_PATTERNS = (
    ...
    r"\bmeteo\b",
    r"\bweather\b",
    r"\bcombien (ca|ça) coute\b",
    r"\bcombien coute\b",
    r"\bprix moyen\b",
    r"\bbien voyager\b",
    r"\bvoyager pas cher\b",
    r"\bquand (visiter|partir|aller)\b",
    r"\bmeilleure (saison|periode|epoque)\b",
    r"\bquelle (saison|periode|epoque)\b",
    r"\best.?ce que le maroc\b",
    r"\bcomment (se deplacer|aller|voyager)\b",
    r"\bque (signifie|veut dire)\b",
    r"\bexplique\b",
    r"\bq?u est.?ce (que|qu)\b",
)
_DARIJA_TERMS = (
    "bghit",
    "kayn",
...
_PREFERENCE_TERMS = {
    ...
    "pas cher": ("pas cher", "bon marche", "cheap", "budget", "rkhis", "drar", "economique", "abordable", "low cost"),
    "luxe": ("luxe", "premium", "haut de gamme", "ghali", "expensive", "5 etoiles", "upscale"),
    "calme": ("calme", "quiet", "tranquille", "saktiya", "paisible", "serein"),
    "familial": ("familial", "famille", "family", "kids", "drari", "wlad", "enfants", "enfant", "children", "child"),
    "romantique": ("romantique", "romantic", "couple", "amour", "ma femme", "ma copine", "wife", "girlfriend", "honeymoon"),
    "coucher de soleil": ("coucher de soleil", "sunset", "golden hour", "ghroob chams"),
    "photos": ("photo", "photos", "photogenique", "instagram", "instagrammable", "shooting", "photographie", "selfie"),
    "culture": ("culture", "culturel", "culturelle", "artistique", "art", "patrimoine", "musee", "galerie"),
    "historique": ("historique", "heritage", "patrimoine", "ancienne medina", "architecture", "histoire", "ancient"),
    "vue panoramique": ("vue panoramique", "panorama", "panoramique", "point de vue", "viewpoint", "vue sur", "belveder"),
    "balade": ("balade", "promenade", "walk", "stroll", "corniche", "randonnee", "hiking", "trekking"),
    "wifi": ("wifi", "wi fi", "internet"),
    "terrasse": ("terrasse", "rooftop", "outside", "exterieur"),
    "ouvert tard": ("ouvert tard", "late night", "ouvert 24h", "24h", "24 7"),
    "vue mer": ("vue mer", "sea view", "ocean view", "bord de mer", "front de mer", "seafront"),
    "travail": ("travail", "coworking", "teletravail", "ordinateur", "pc", "work"),
    "marocain": ("marocain", "marocaine", "tajine", "tagine", "couscous", "rfissa", "pastilla"),
    "italien": ("italien", "italienne", "pizza", "pasta", "pates"),
    "vegetarien": ("vegetarien", "vegetarienne", "vege", "veggie", "sans viande", "vegan"),
    "halal": ("halal",),
    "jus": ("jus", "juice", "smoothie", "jam", "jam3"),
    "enfants": ("enfants", "enfant", "kids", "children", "bebe", "tout petit", "drari", "wlad"),
    "accessible": ("accessible", "handicap", "pmr", "wheelchair", "fauteuil", "mobilite reduite"),
    "sport": ("sport", "sportif", "fitness", "gym", "piscine", "tennis", "surf", "aventure", "escalade"),
    "brunch": ("brunch", "petit dejeuner", "breakfast", "matin", "ftour"),
    "seafood": ("seafood", "fruits de mer", "poisson", "mer", "hout", "poissonnerie"),
    "jardin": ("jardin", "garden", "parc", "verdure", "nature", "vert", "fleurs"),
}
